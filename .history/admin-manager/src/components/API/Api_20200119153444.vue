<script type="text/javascript">
    ...
    // const httpIp = "https://www.iperfumetech.com";//测试
    //const httpIp = "http://47.95.200.91";//正式
    const httpIp = "http://localhost";
    // const port = "9000";
    // const hot = httpIp + ":";// + port;
    //const hot = 'http://www.houluzhai.top:8081';
    ...
    //设备故障
    const getSkTroublesByDeviceId = '/waterMachine/backend/device/getSkTroublesByDeviceId';
    ...
    //优惠券-优惠券列表
    const getCouponPage = '/waterMachine/backend/coupon/getCouponPage';
    //优惠券详情
    const getCouponDetail = '/waterMachine/backend/coupon/getCouponDetail';
    //编辑优惠券
    const getCouponEdit = '/waterMachine/backend/coupon/edit';
    //新增优惠券
    const getCouponSave = '/waterMachine/backend/coupon/save';
    //发布优惠券
    const getCouponPublish = '/waterMachine/backend/coupon/publish';
    //删除优惠券
    const getCouponRemove = '/waterMachine/backend/coupon/remove';
    //活动-活动列表
    const getActivityPage = '/waterMachine/backend/activity/getActivityPage';
    //活动详情
    const getActivityDetail = '/waterMachine/backend/activity/getActivityDetail';
    //活动编辑
    const getActivityEdit = '/waterMachine/backend/activity/edit';
    //活动新增
    const getActivitySave = '/waterMachine/backend/activity/save';
    //活动发布
    const getActivityPublish = '/waterMachine/backend/activity/publish';
    //活动删除
    const getActivityRemove = '/waterMachine/backend/activity/remove';
